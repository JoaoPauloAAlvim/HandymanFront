                                ...
                                <div key={index} className="bg-white rounded-xl shadow-lg hover:shadow-xl transition-shadow duration-300 cursor-pointer">
                                        ...
                                        <div className="flex items-center justify-between mb-4">
                                            <div className="flex items-center space-x-4">
                                                ...
                                                <div>
                                                    ...
                                                    {solicitacao.usuario && solicitacao.usuario.media_avaliacoes !== undefined && solicitacao.usuario.media_avaliacoes !== null && (
                                                        <div className="flex items-center mt-1">
                                                            {[1,2,3,4,5].map((star) => (
                                                                <svg
                                                                    key={star}
                                                                    className={`w-4 h-4 ${star <= Math.round(solicitacao.usuario.media_avaliacoes as number) ? 'text-yellow-400' : 'text-gray-300'}`}
                                                                    fill="currentColor"
                                                                    viewBox="0 0 20 20"
                                                                >
                                                            ...
                                                            <span className="ml-1 text-xs text-gray-600">{(solicitacao.usuario.media_avaliacoes as number).toFixed(1)}</span>
                                                        </div>
                                                    )}
                                    ...
                                    <div className="p-6">
                                        ...
                                        <div className="mt-6 space-y-3">
                                            ...
                                            {(['aguardando pagamento', 'concluido', 'concluído'].includes((solicitacao.servico.status || '').toLowerCase()) && (solicitacao.servico.avaliado === false || solicitacao.servico.avaliado === undefined)) && (
                                                <button
                                                    onClick={() => navigate(`/exibirAgenda/${solicitacao.servico.id_servico}`)}
